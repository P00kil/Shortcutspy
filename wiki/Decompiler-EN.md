...
> **See also:** [README_EN](https://github.com/P00kil/Shortcutspy/blob/main/README_EN.md#decompiler)
...
- [Getting Started](Getting-Started-EN) for building new shortcuts from scratch
- [Core Concepts](Core-Concepts-EN) for outputs, variables, and control flow
- [FAQ](FAQ-EN) for common questions about editing and compatibility