...
> **Deutsch?** → [Getting Started](Getting-Started)
...
1. **[Core Concepts](Core-Concepts-EN)** — Learn about actions and outputs
2. **[FAQ](FAQ-EN)** — Answers to common questions
3. **[Troubleshooting](Troubleshooting-EN)** — Help with problems
